	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
	        ...
	        while(rs.next()){
	            ...
	            //Display values
	            out.println("albumName: " + aName + "<br>");
	            out.println(", albumCountry: " + aCountry + "<br>");
	            out.println(", albumLanguage: " + aLanguage + "<br>");
	            out.println(", albumId: " + aId + "<br>");
	            out.println(", songId: " + sId + "<br>");
	        }
